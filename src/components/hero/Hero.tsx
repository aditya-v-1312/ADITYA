...
export default function Hero() {
  return (
    <section className="flex min-h-screen items-center overflow-hidden">
      <Container>
        <div className="flex min-h-[85vh] flex-col items-center justify-between gap-16 lg:flex-row">
          {/* Left Side */}
          <div className="w-full lg:w-1/2">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <a
                href="#projects"
                className="rounded-xl bg-blue-600 px-6 py-3 font-medium text-white transition-all duration-300 hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-500/20"
              >
                View Projects
              </a>
              ...
              <a
                ...
                className="rounded-xl border border-slate-700 px-6 py-3 font-medium text-white transition-all duration-300 hover:border-blue-500 hover:bg-white/5"
              >
                Resume
              </a>
            </div>
